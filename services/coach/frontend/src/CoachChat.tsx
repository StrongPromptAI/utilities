...
export function CoachChat() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="sticky top-0 z-10 px-4 py-3 backdrop-blur bg-page/70 border-b border-accent-light">
        <div className="max-w-2xl mx-auto flex items-center gap-2.5">
          ...
          <span className="text-sm font-semibold text-text">DME Sales Coach</span>
        </div>
      </header>
